...
public class GuildMusic {
    ...
    public void scheduleLeave() {
        MusicManager.LOGGER.debug("{Guild ID: {}} Scheduling auto-leave", this.guildId);
    ...
    public void cancelLeave() {
        if (this.isLeavingScheduled()) {
            MusicManager.LOGGER.debug("{Guild ID: {}} Cancelling auto-leave", this.guildId);
            this.leavingTask.get().dispose();
        }
    }

    public void addAudioLoadResultListener(AudioLoadResultListener listener) {
        MusicManager.LOGGER.debug("{Guild ID: {}} Adding audio load result listener: {}", this.guildId, listener.hashCode());
    ...
    public void removeAudioLoadResultListener(AudioLoadResultListener listener) {
        MusicManager.LOGGER.debug("{Guild ID: {}} Removing audio load result listener: {}", this.guildId, listener.hashCode());
        this.listeners.remove(listener);
    }

    public Mono<Message> end() {
        MusicManager.LOGGER.debug("{Guild ID: {}} Ending guild music", this.guildId);
