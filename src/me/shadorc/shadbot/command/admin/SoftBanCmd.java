...
public class SoftBanCmd extends AbstractCommand {
	...
	public EmbedObject getHelp(String prefix) {
		return new HelpBuilder(this, prefix)
				.setDescription("Ban and instantly unban an user.\nIt's like kicking him but it also deletes his past messages.")
				.addArg("@user(s)", "users to softban", false)
				.addArg("reason", "the softban reason", true)
				.build();
	}
