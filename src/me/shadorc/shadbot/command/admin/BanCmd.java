...
// throw new IllegalCmdArgumentException(String.format("You can't ban **%s** because he has the same or a higher role "
// + "position than you in the role hierarchy.",
// mentionedUser.getName()));
// }
// if(!BotUtils.canInteract(context.getGuild(), mentionedUser)) {
// throw new IllegalCmdArgumentException(String.format("I cannot ban **%s** because he has the same or a higher role "
