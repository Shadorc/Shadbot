...
// throw new HttpStatusException("Fortnite API did not return a valid status code.", HttpStatus.SC_SERVICE_UNAVAILABLE, url.toString());
// }
//
// JSONObject mainObj = new JSONObject(response.parse().body().html());
//
// System.err.println(mainObj.toString(2));
//
// // Useful: http://pojo.sodhanalibrary.com/
