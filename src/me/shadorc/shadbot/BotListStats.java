...
public class BotListStats {
	...
	private void postOnBotListDotSpace(Long guildCount) {
		...
		try {
			...
			LogUtils.warn("An error occurred while posting statistics on botlist.space: %s", err.getMessage());
		}
	}
	...
	private void postOnBotsOndiscordXyz(Long guildCount) {
		...
		try {
			...
			LogUtils.warn("An error occurred while posting statistics on bots.ondiscord.xyz: %s", err.getMessage());
		}
	}
	...
	private void postOnDiscordBotListDotCom(Long guildCount) {
		...
		for(final DiscordClient client : clients) {
			...
			try {
				...
				LogUtils.warn("An error occurred while posting statistics on discordbotlist.com: %s", err.getMessage());
			}
		}
	}
	...
	private void postOnDiscordBotsDotGg(Long guildCount) {
		...
		for(final DiscordClient client : clients) {
			...
			try {
				...
				LogUtils.warn("An error occurred while posting statistics on discord.bots.gg: %s", err.getMessage());
			}
		}
	}
	...
	private void postOnDiscordBotsDotOrg(Long guildCount) {
		...
		for(final DiscordClient client : clients) {
			...
			try {
				...
				LogUtils.warn("An error occurred while posting statistics on discordbots.org: %s", err.getMessage());
			}
		}
	}
	...
	private void postOnDivineDiscordBotsDotCom(Long guildCount) {
		...
		try {
			...
			LogUtils.warn("An error occurred while posting statistics on divinediscordbots.com: %s", err.getMessage());
		}
	}
